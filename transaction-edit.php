...
<?php
    ...
    //create insert query
        $query ="UPDATE transaction SET datelog='$datelog', documentcode='$documentcode', action='$action', remarks='$remarks', 
                                        ...
                                        <div class="col-md-3 pr-1">
                                            ...
                                            <div class="col-md-3 pr-1">
                                                <div class="form-group">
                                                    ...
                                                    <input name="documentcode" type="text" class="form-control" placeholder="Type here..." value=" <?php echo $documentcode; ?> ">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3 px-1">
                                                <div class="form-group">
                                                    ...
                                                    <option value="IN" <?php if($action=="IN") echo 'selected="selected"'; ?> >IN</option>

                                                        <option value="OUT" <?php if($action=="OUT") echo 'selected="selected"'; ?> >OUT</option>

                                                        <option value="COMPLETE" <?php if($action=="COMPLETE") echo 'selected="selected"'; ?> >COMPLETE</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 pl-1">
                                                <div class="form-group">
                                                    ...
                                                    <input name="remarks" type="text" class="form-control" placeholder="Type here..." value=" <?php echo $remarks; ?> ">
                                                </div>
                                            </div>
                                        </div>
